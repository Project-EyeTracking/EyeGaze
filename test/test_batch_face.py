...
if __name__ == "__main__":
    ...
    # now we recommend to specify return_dict=True to get the result in a more readable way
    ...
    for face in faces:
        ...
        cv2.putText(
            img, score_text, (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 255), 2
        )
