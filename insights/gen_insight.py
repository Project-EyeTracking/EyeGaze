...
def main():
    ...
    instruction_df = pd.read_csv("D:\MAI\THWS\project\EyeGaze\insights\inst.csv")    #need to be configured later
    observation_df = pd.read_csv("D:\MAI\THWS\project\EyeGaze\insights\obs_2.csv")
    ...
    time_window = 3  #time_period of  a time level
