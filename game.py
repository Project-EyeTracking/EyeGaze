...
def game():
    ...
    cap.set(cv2.CAP_PROP_AUTOFOCUS, 0) #to disable auto focus
    ...
    game_video_csv_file_path = CWD / "output" / f'Game_Video_{time_now}.avi'
    ...
    # Excel setup
    game_excel_file_path = CWD / "output" / f'Game_Coordinates_{time_now}.xlsx'
    ...
    return game_excel_file_path, game_video_csv_file_path
