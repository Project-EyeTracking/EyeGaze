...
def setup_screen():
    ...
    running = True
    selected_movement = "Horizontal"  # Default selection
    ...
    while running:
        ...
        screen.blit(diagonal_text, (center_x + 75 + 20, movement_y_start + 10))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if (
                    ...
                    )  # Extend with sound or visual feedback as desired.
